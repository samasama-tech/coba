        ...
        <div class="bg-light p-4 rounded shadow">
            ...
            <form action="kamar.php" method="POST" class="row g-3 align-items-end">
                <div class="col-md-3">
                    ...
                    <input type="date" name="ci" id="ci" class="form-control" value="<?= htmlspecialchars($ci) ?>"
                        required>
                </div>
                <div class="col-md-3">
                    <label for="co" class="form-label">Check-out</label>
                    <input type="date" name="co" id="co" class="form-control" value="<?= htmlspecialchars($co) ?>"
                        required>
                </div>
                <div class="col-md-2">
                    <label for="kap" class="form-label">Kapasitas</label>
